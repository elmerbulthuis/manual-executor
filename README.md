...
This is a manual executor for driving futures to readiness. You need to manually wake the promise! But of course what else dit you expect from an executor that is called manual-executor. Because of the manual nature the use cases of this executor are limited.
